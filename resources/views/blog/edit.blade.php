...
<div class="container mx-auto py-10">
    <h1 class="text-4xl font-bold text-center mb-8">Update Post</h1>
    ...
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <form action="/blog/{{ $post->slug }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <textarea name="description" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline h-32">{{ $post->description }}</textarea>
            </div>
